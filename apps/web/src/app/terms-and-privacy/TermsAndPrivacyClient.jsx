                        ...
                        >
                            ...
                            <ContentSection id="privacy_8" activeId={activeId} title="第八條、個人資料之蒐集類別與目的">
                                ...
                                <div className="mt-4 bg-page rounded-xl border border-line px-4 sm:px-5 py-1 not-prose">
                                    ...
                                    <DataRow category="自備 AI 金鑰（校外使用者）" items="您的 Gemini API 金鑰。選擇「存於雲端」者以 AES-256-GCM 加密後保存；選擇「僅存本機」者平台僅保存末四碼遮罩提示，完整金鑰留在您的裝置" source="您主動輸入（可隨時更換或清除）" />
                                </div>
                            ...
                            <ContentSection id="privacy_9" activeId={activeId} title="第九條、個人資料之處理與利用">
                                <ol className="list-decimal pl-5 space-y-3">
                                    ...
                                    <li><strong>校外使用者自備之 AI 金鑰</strong>：校外帳號無學號，須提供自己的 Google Gemini API 金鑰，AI 功能一律以該金鑰呼叫，用量與費用計入您本人的 Google 帳號。金鑰僅用於代您呼叫 Gemini，不會被顯示、匯出或提供給第三人：選擇「存於雲端」時以 AES-256-GCM 加密存放於僅伺服器可存取之資料表，選擇「僅存本機」時完整金鑰只留在您的瀏覽器或 App 安全儲存區、由您的裝置於每次請求時附帶。您可隨時更換金鑰；<strong>清除金鑰將同時註銷帳號</strong>（校外帳號之功能均以金鑰為前提），註銷後資料依第十二條刪除。您在 Google AI Studio 的金鑰本身不會被平台刪除，可自行前往撤銷。</li>
